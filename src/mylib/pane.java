...
public class pane {
    ...
    public Component gettextpane(String num) {
        pane = new JPanel();
        jmenubar bar=new jmenubar(0,0,this.width,40,"Bar");
        ...
        String[] buttVal={"7","8","9","CLR","4","5","6","/","1","2","3","-",".","0","=","*","^","(",")","00" };
        int x = 10;
        int y = 140;
        int space = 40;
        ...
        for (int i = 0; i < 20; i++) {
            ...
            button = butt[i].getButton(buttVal[i]);
            pane.add(button);

            jtext inp=new jtext(10,50,(this.width-20),40,buttVal[i]);
            Component gettextarea = inp.gettextarea(button);
